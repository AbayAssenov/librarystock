...
public class LibraryConstatnt {
    ...
    public static final String FORMAT_REGISTERED_PUB_BODY="%-10s%-10s%-20s%-20s%-15s%-15s%n";
    ...
    public static final String INPUT_ID_PUB="Введите id издания для удаления";
    ...
    public static final String INPUT_YEAR_PUB="Введите жанр издания. Максимальное кол-во символов ";
